...
- 2026-09-01: Recovered previously-untracked Hermes operational scripts (including the separately audited session-save helper) and custom plugin source into hermes-config. Runtime-installed skills, caches, state, and the cp7-agent-stack-owned shared-bootstrap deployment remain outside curated source.
